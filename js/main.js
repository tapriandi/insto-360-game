...
panorama = new PANOLENS.ImagePanorama('./assets/2.jpg');
panorama_area = new PANOLENS.ImagePanorama('./assets/1.jpg');
panorama.addEventListener('progress', onProgress);
panorama.addEventListener('load', onLoad);
panorama.addEventListener('enter', onEnter);
panorama.add(rulesInfospot, valveInfospot, endingInfospot);

panorama.link( panorama_area, new THREE.Vector3(4637.61, 250, -4000) );
panorama_area.link( panorama, new THREE.Vector3(4637.61, -1098.12, -1071.24) );
...
//   $('#insto-video > video').removeClass('hidden');
//   $('#insto-video > video').get(0).play();
// });
// posterInfospot_2.show();
// posterInfospot_2.focus();
